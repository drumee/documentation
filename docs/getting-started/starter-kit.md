...
Node.js server and service code

plugins

/var/lib/drumee/plugins

Custom plugins

docker.d

/var/lib/drumee/start.d

Start and configure scripts
...
# Check the entity pool (should grow over time toward ~210 per type)
